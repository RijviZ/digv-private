          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isDarkMode ? const Color(0xFF332005) : const Color(0xFFFFF7ED),
                  borderRadius: BorderRadius.circular(6),
                  border: Border.all(color: isDarkMode ? const Color(0xFF7C2D12) : const Color(0xFFFED7AA)),
                ),
                child: Text(
                  l10n.lang_notice,
                  style: AppTextStyles.caption.copyWith(
                    color: isDarkMode ? const Color(0xFFFB923C) : const Color(0xFFC2410C),
                  ),
                ),
              ),
            ],
